...
//icon
import {Dumbbell, Bike, Beef, HeartPulse, Pencil, Trash2, ChevronDown, ChevronUp} from "lucide-react";
                    ...
                    <div className="flex flex-col gap-6 mx-auto px-6">
                        ...
                        <div className="flex flex-col items-center gap-3">
                            <div className="w-full bg-[var(--secondary)] p-4 rounded-lg shadow">
                                <div onClick={() => setIsOpenAddService(prev => !prev)}
                                     className={`w-full flex items-center ${isOpenAddService ? 'mb-4' : 'mb-0'} justify-between`}>
                                    <div className="flex items-center gap-2 ">
                                ...
                                {
                                    isOpenAddService && <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                        {/* Service Name Field */}
                                        <div className="relative">
                                            <input
                                                {...register("name")}
                            ...
                            <div className="w-full flex flex-col gap-2 max-h-[calc(100vh-280px)] hide-scrollbar overflow-y-auto">
                            {isLoading ? (
